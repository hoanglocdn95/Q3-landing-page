    ...
    <footer className="bg-white py-12 px-4 md:px-8 border-t">
      <div className="section-container">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="font-bold text-text-primary mb-4">{t.quickLinks.title}</h3>
            <ul className="space-y-3">
              <li>
                <Link href="#" className="text-sm text-dark font-medium hover:text-primary">
                  {t.quickLinks.about}
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="font-bold text-text-primary mb-4">{t.contactInfo.title}</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                <PhoneIcon />
                <span className="text-sm text-dark font-medium">(028) 1231 456</span>
              </li>
              <li className="flex items-start">
                <MailIcon />
                <span className="text-sm text-dark font-medium">mail@example.com</span>
              </li>
              <li className="flex items-start">
                <MapPinIcon />
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center border-gray-200">
          ...
          <div className="text-sm text-dark font-medium">{t.footer.copyright}</div>
          <div className="flex space-x-3 mt-4 md:mt-0">
            <Link href="#" aria-label="Youtube" className="text-dark hover:text-primary">
              <YoutubeDarkIcon />
            </Link>
