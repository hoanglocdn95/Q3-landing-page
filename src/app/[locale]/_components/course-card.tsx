...
export default function CourseCard({
  ...
  return (
    <div className="group w-[calc(100vw-32px)] max-w-[300px] rounded-lg bg-white transition-all duration-300 hover:-translate-y-1 sm:w-auto sm:max-w-[unset]">
      ...
      <Link href={`/${locale}/courses/${slug}`}>
        <div className="rounded-8 relative mx-auto mt-[-36px] w-[90%] bg-white p-4 shadow-sm transition-all duration-300 group-hover:shadow-lg">
