  ...
  return (
    <div className="relative py-10 md:py-15 lg:py-20">
      <section className="section-container">
        ...
        <h2 className="text-text-primary mb-10 text-center text-2xl font-bold lg:text-[40px] lg:leading-[72px]">
          Đội ngũ giáo viên
        </h2>
              ...
              >
                <div className="relative aspect-[3/4] w-full">
                  ...
                  <div className="absolute bottom-10 left-0 w-full text-center text-white">
                    <h3 className="mb-3 text-[28px] leading-tight font-bold">
                      {teacher.name}
                    </h3>
        ...
        <div className="mt-8 flex justify-center">
          <Link
            href="/teachers"
            className="inline-flex items-center rounded-full bg-[#03044f] px-4 py-2 text-sm font-medium text-white"
          >
            Xem tất cả
